    ...
    <div className="flex flex-col">
      <div className="bg-white rounded-lg p-4 drop-shadow-sm flex flex-col space-y-2 mt-5">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h1 className="text-2xl font-semibold mb-4">Ajouter un articles </h1>
              <h1 className="text-lg font-semibold mb-4">Ici, vous pouvez ajouter un articles</h1>
            </div>
            ...
            <Dialog >
                ...
                <DialogContent className="max-w-4xl sm:max-w-2xl md:max-w-3xl lg:max-w-6xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Veuillez renseigner le titre de l'article à ajouter
                    </DialogDescription>
                  </DialogHeader>
                  <form
                    ...
                    className="bg-white border-lg p-4 space-y-2 border"
                            >
                  <Input placeholder="Titre d'article" name="title" required/>
