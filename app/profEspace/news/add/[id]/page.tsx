...
const Classes = ({params}:any) => {
  ...
  const addNews = async (formData: FormData) => {
    ...
    try {
      ...
      formData.append("teacherId", params.id);

      const response = await axios.post(`/api/prof/classes/${formData.get("classe")?.toString()}/news`,formData,
      {
        headers: {
                ...
                <TableCell className="text-right">
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                      <DialogHeader>
                        <DialogTitle>Ajouter Publication</DialogTitle>
                        <DialogDescription>
                      ...
                      <form
                        ...
                        className="bg-white border-lg p-4 space-y-2 border"
                                >
                      <Input placeholder="Titre de nouvelle" name="classId" required value={classe.id}/>
